...
111. 什么是 Python，使用它有什么好处，你对 PEP 8 有什么理解？

112. 以下 Python 代码片段的输出是什么？证明你的答案。

113. 如果程序不需要动作但在语法上需要它，可以在 Python 中使用的语句是什么？

114. 在 Python 中使用“~”获取主目录的过程是什么？

115. Python 中可用的内置类型有哪些？

116. 如何在 Python 应用程序中查找错误或执行静态分析？

117. 什么时候使用 Python 装饰器？

118. 列表和元组的主要区别是什么？

119. Python 如何处理内存管理？

120. lambda 和 def 之间的主要区别是什么？

121. 使用 python reg 表达式模块“re”编写一个 reg 表达式来验证电子邮件 ID？

122. 你认为以下代码片段的输出是什么？代码中有错误吗？

123. Python 中有 switch 或 case 语句吗？如果不是，那么相同的原因是什么？

124. Python 用来迭代数字序列的内置函数是什么？

125. Python 的 try-except 块中可能有哪些可选语句？
...
129. 字符串在 Python 中是不可变的还是可变的？

130. Python 中的索引是什么？ 

131. Python 中的文档字符串是什么？

132. Python 编程中的函数是什么？

133. Python 中有多少基本类型的函数？

134. 我们如何用 Python 编写函数？

135. Python 中的函数调用或可调用对象是什么？

136. Python 中的 return 关键字是做什么用的？

137. Python 中的“按值调用”是什么？

138. Python 中的“按引用调用”是什么？

139. trunc() 函数的返回值是多少？

140. Python 函数必须返回一个值吗？

141. Python 中的 continue 有什么作用？

142. Python 中 id() 函数的用途是什么？

143. *args 在 Python 中有什么作用？

144. **kwargs 在 Python 中做什么？

145. Python 有 Main() 方法吗？

146.  __ Name __ 在 Python 中有什么作用？

147. Python 中“end”的目的是什么？

148. 什么时候应该在 Python 中使用“break”？

149. Python 中的 pass 和 continue 有什么区别？

150. len() 函数在 Python 中有什么作用？

151. chr() 函数在 Python 中有什么作用？

152. ord() 函数在 Python 中有什么作用？

153. Python 中的 Rstrip() 是什么？

154. Python 中的空格是什么？

155. Python 中的 isalpha() 是什么？

156. 你如何在 Python 中使用 split() 函数？

157. Python 中的 join 方法有什么作用？

158. Title() 方法在 Python 中有什么作用？

159. 是什么让 CPython 与 Python 不同？

160. 哪个包是最快的 Python 形式？

161. Python 语言中的 GIL 是什么？
...
165. Python 编程中的字典是什么？

166. Python 中的 set 对象是什么？

167. 字典在 Python 中有什么用？

168. Python 列表是链表吗？

169. Python 中的 Class 是什么？

170. Python 类中的属性和方法是什么？

171. 如何在运行时为 Class 属性赋值？

172. Python 编程中的继承是什么？

173. Python 中的组合是什么？

174. Python 程序中的错误和异常是什么？

175. 你如何在 Python 中使用 Try/Except/Finally 处理异常？

176. 你如何为 Python 中的预定义条件引发异常？

177. 什么是 Python 迭代器？

178. Iterator 和 Iterable 有什么区别？
...
182. 你如何在 Python 中创建字典？

183. 你如何在 Python 中读取字典？

184. 如何在 Python 中遍历字典对象？

185. 你如何在 Python 中向字典添加元素？

186. 如何在 Python 中删除字典的元素？

187. 你如何检查字典中键的存在？

188. Python 中列表推导式的语法是什么？

189. Python 中字典理解的语法是什么？

190. Python 中生成器表达式的语法是什么？
